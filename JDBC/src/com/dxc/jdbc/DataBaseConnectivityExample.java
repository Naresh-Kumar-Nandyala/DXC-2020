...
public class DataBaseConnectivityExample {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Server Conneected");
		// Step 2
		...
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/contactdb", "root", "1525210511");
		System.out.println("Server Conneected");
		
		// Step 3

		/**********************  Inserting Into DataBase  ***************************/
		/*PreparedStatement stmtInsert = con.prepareStatement("insert into details(?,?,?,?,?)");
		...
		stmtInsert.setInt(5, 3214);
		System.out.println(stmtInsert.executeUpdate() + " No of Records Inserted");*/
		
		
		String query="insert into details(empid,name,gmail,Location,phone)"+"values(?,?,?,?,?)";
		PreparedStatement stmtInsert = con.prepareStatement(query);
		stmtInsert.setInt(1, 4);
		stmtInsert.setString(2, "Dinesh");
		stmtInsert.setString(3, "dinesh@gmail.com");
		stmtInsert.setString(4, "ATP");
		stmtInsert.setLong(5, 88864245);
